...
public class Tile {
    ...
    private Robot robot = StartGame.getRobot();
    ...
    public Tile(int x, int y, int typeint){
        ...
        r = new Rectangle();    
        if (type == 2)
            tileImage = StartGame.grasstop; 
        else if (type == 3)
            tileImage = StartGame.tiledirt;
        else if (type == 4)
            tileImage = StartGame.tilestone;
        else if (type == 5)
            tileImage = StartGame.tiletree;
        else if (type == 6)
            tileImage = StartGame.tilerock;
        else {
            type = 0;
        }
    }
